...
reply_markup = InlineKeyboardMarkup(
        [[
        InlineKeyboardButton("Fᥱrmᥱr", callback_data='close_data')
        ]]
    )
...
async def short(link):
    ...
    try:
        ...
        print(f"TinyURL.com erreur :- {error}")
    ...
    try:
        ...
        print(f"NullPointer erreur :- {error}")
